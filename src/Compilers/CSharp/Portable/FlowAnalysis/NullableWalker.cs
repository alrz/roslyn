...
#nullable restore
        ...
        protected override ImmutableArray<PendingBranch> Scan(ref bool badRegion)
        {
            ...
            bool parameterHasBadState(ParameterSymbol parameter, bool sense, LocalState stateWhen)
            {
                ...
                if (refKind is not (RefKind.Out or RefKind.Ref))
                {
                    return false;
                }
            ...
            {
                if (member.Kind is not (SymbolKind.Field or
                    SymbolKind.Property))
                {
                    return -1;
                }
...
#nullable restore
        ...
        protected override void VisitBinaryOperatorChildren(ArrayBuilder<BoundBinaryOperator> stack)
        {
            ...
            bool learnFromBooleanConstantTest()
            {
                ...
                if (op is not (BinaryOperatorKind.Equal or BinaryOperatorKind.NotEqual))
                {
                    return false;
                }

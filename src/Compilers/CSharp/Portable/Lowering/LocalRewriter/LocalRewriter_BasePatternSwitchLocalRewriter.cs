    ...
    internal partial class LocalRewriter
    {
        ...
        private abstract class BaseSwitchLocalRewriter : PatternLocalRewriter
        {
            ...
            private void LowerDecisionDagCore(BoundDecisionDag decisionDag)
            {
                ...
                ImmutableArray<BoundDecisionDagNode> nodesToLower = sortedNodes.WhereAsArray(n => n.Kind is not (BoundKind.WhenDecisionDagNode or BoundKind.LeafDecisionDagNode));
